package tdtu.seminar.weatherapp.view
...
import tdtu.seminar.weatherapp.R
import tdtu.seminar.weatherapp.viewmodel.MainViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var cName = GET.getString("cityName","Saigon")
    ...
    private fun getLiveData() {
        viewModel.weather_data.observe(this, Observer { data ->
            data?.let {
                ...
                Glide.with(this).load("http://openweathermap.org/img/wm" + data.weather.get(0).icon + "@2x.png")
                    .load(img_weather_icon)
            }
        })
